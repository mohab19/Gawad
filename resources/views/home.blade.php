...
<!--////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
      <div class="row">
        <div class="col-lg-12">
          <!-- Card Columns Example Social Feed-->
          <div class="mb-0 mt-4">
            <i class="fa fa-newspaper-o"></i> Category One <input type="button" value="Add Category" style="float:right;margin-top: -10px;width: 13%;" class="btn btn-primary" data-toggle="modal" data-target="#myModal_98">
          </div>
            <!-- The Modal -->
              <div class="modal fade" id="myModal_98">
              <div class="modal-dialog">
                <div class="modal-content">
                ...
                <!-- Modal body -->
                <div class="modal-body">
                  <form method="POST" id="modal_98" name="modal_8" action="{{ route('home.storeOne' , 2 )}}" enctype="multipart/form-data">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}?" >
                  <div class="form-group">
                    <label>Title:</label>
                    <input type="text" class="form-control" id="title" placeholder="Enter Title" name="name" >
                  ...
                  <div class="form-group">
                    <input type="text" name="flag" value="2" style="display:none">
                  <!--  <input type="text" name="disc" value="..." style="display:none"> -->
                  </div>
                  <input type="submit" value="Save" class="btn btn-success " >
                  <input type="hidden" name="_token" value="{{ Session::token() }}">
...
<!--////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
      <div class="row">
        <div class="col-lg-12">
          <!-- Card Columns Example Social Feed-->
          <div class="mb-0 mt-4">
            <i class="fa fa-newspaper-o"></i> Product One <input type="button" value="Add Product" style="float:right;margin-top: -10px;width: 13%;" class="btn btn-primary" data-toggle="modal" data-target="#myModal_97">
          </div>
            <!-- The Modal -->
              <div class="modal fade" id="myModal_97">
              <div class="modal-dialog">
                <div class="modal-content">
                ...
                <!-- Modal body -->
                <div class="modal-body">
                  <form method="POST" id="modal_97" name="modal_8" action="{{ route('home.storeOne' , 3 ) }}" enctype="multipart/form-data">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}?" >
                  <div class="form-group">
                    <label>Title:</label>
                    <input type="text" class="form-control" id="title" placeholder="Enter Title" name="name" >
                  ...
                  <div class="form-group">
                    <input type="text" name="flag" value="3" style="display:none">
                  <!--  <input type="text" name="disc" value="..." style="display:none"> -->
                  </div>
                  <input type="submit" value="Save" class="btn btn-success " >
                  <input type="hidden" name="_token" value="{{ Session::token() }}">
         ...
         <div class="form-group" style="display:inline-flex;">
               ...
               <!-- The Modal -->
                 ...
                 <div class="modal-dialog">
                   ...
                   <!-- Modal Header -->
                   <div class="modal-header">
                     <h4 class="modal-title">Edit Product One</h4>
                     <button type="button" class="close" data-dismiss="modal">&times;</button>
                   </div>
                   <!-- Modal body -->
                   <div class="modal-body">
...
<!--////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
      <div class="row">
        <div class="col-lg-12">
          <!-- Card Columns Example Social Feed-->
          <div class="mb-0 mt-4">
            <i class="fa fa-newspaper-o"></i> Product Two <input type="button" value="Add Product" style="float:right;margin-top: -10px;width: 13%;" class="btn btn-primary" data-toggle="modal" data-target="#myModal_101">
          </div>
            <!-- The Modal -->
              <div class="modal fade" id="myModal_101">
              <div class="modal-dialog">
                <div class="modal-content">
                ...
                <!-- Modal body -->
                <div class="modal-body">
                  <form method="POST" id="modal_101" name="modal_8" action="{{ route('home.storeOne', 5 ) }}" enctype="multipart/form-data">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}?" >
                  <div class="form-group">
                    <label>Title:</label>
                    <input type="text" class="form-control" id="title" placeholder="Enter Title" name="name" >
                  ...
                  <div class="form-group">
                    <input type="text" name="flag" value="5" style="display:none">
                  <!--  <input type="text" name="disc" value="..." style="display:none"> -->
                  </div>
                  <input type="submit" value="Save" class="btn btn-success " >
                  <input type="hidden" name="_token" value="{{ Session::token() }}">
         ...
         <div class="form-group" style="display:inline-flex;" >
               ...
               <!-- The Modal -->
                 ...
                 <div class="modal-dialog">
                   ...
                   <!-- Modal Header -->
                   <div class="modal-header">
                     <h4 class="modal-title">Edit Product Twq</h4>
                     <button type="button" class="close" data-dismiss="modal">&times;</button>
                   </div>
                   <!-- Modal body -->
                   <div class="modal-body">
...
<!--////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
      <div class="row">
        <div class="col-lg-12">
          <!-- Card Columns Example Social Feed-->
          <div class="mb-0 mt-4">
            <i class="fa fa-newspaper-o"></i> Product Three <input type="button" value="Add Product" style="float:right;margin-top: -10px;width: 13%;" class="btn btn-primary" data-toggle="modal" data-target="#myModal_90">
          </div>
            <!-- The Modal -->
              <div class="modal fade" id="myModal_90">
              <div class="modal-dialog">
                <div class="modal-content">
                ...
                <!-- Modal body -->
                <div class="modal-body">
                  <form method="POST" id="modal_90" name="modal_8" action="{{ route('home.storeOne' , 6) }}" enctype="multipart/form-data">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}?" >
                  <div class="form-group">
                    <label>Title:</label>
                    <input type="text" class="form-control" id="title" placeholder="Enter Title" name="name" >
                  ...
                  <div class="form-group">
                    <input type="text" name="flag" value="6" style="display:none">
                  <!--  <input type="text" name="disc" value="..." style="display:none"> -->
                  </div>
                  <input type="submit" value="Save" class="btn btn-success " >
                  <input type="hidden" name="_token" value="{{ Session::token() }}">
         ...
         <div class="form-group" style="display:inline-flex;">
               ...
               <!-- The Modal -->
                 ...
                 <div class="modal-dialog">
                   ...
                   <!-- Modal Header -->
                   <div class="modal-header">
                     <h4 class="modal-title">Edit Product Three</h4>
                     <button type="button" class="close" data-dismiss="modal">&times;</button>
                   </div>
                   <!-- Modal body -->
                   <div class="modal-body">
